...
{
    public class GetComplaintReportQueryBase(DateTime? from = null, DateTime? to = null, int? govermentalEntityId = null, string? location = null, ComplaintStatus? status = null)
    {
